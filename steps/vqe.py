...
def vqe(backend_specs, coefficients, min_value=min_value, max_value=max_value):
    ...
    min_value = yaml.load(min_value, Loader=yaml.FullLoader)
    max_value = yaml.load(max_value, Loader=yaml.FullLoader)
